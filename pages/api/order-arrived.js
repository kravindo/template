        ...
        const htmlTemplate = ReactDOMServer.renderToStaticMarkup(
            ...
            >
                <span style={{ fontSize: '1.25rem', fontWeight: 600, display: 'block', marginBottom: '0.9rem' }}>
                    Pesanan {order.number} Telah Sampai
                </span>
                    ...
                    <table style={{ width: '100%', border: '1px solid black', borderCollapse: 'collapse' }}>
                        <tr>
                            <td style={{ padding: '0.9rem' }}>
                                ...
                                <span style={{ display: 'block' }}>Tanggal Tiba</span>
                            </td>
                            ...
                            <span style={{ display: 'block', marginBottom: '0.8rem' }}>{order.shipment_vendor}</span>
                                ...
                                <span style={{ display: 'block' }}>{formatDate(order.arrived_date)}</span>
                            </td>
                        </tr>
                    </table>
                </div>
                ...
                <span style={{ display: 'block', marginBottom: '0.9rem' }}>
                    Pengembalian barang dapat dilakukan dalam waktu 30 hari sejak tanggal pengiriman pesanan cek
                    <a href={order.invoice_detail.address_detail.user_detail.company_detail.terms_and_condition_url} style={{ color: 'blue', cursor: 'pointer' }}> Syarat & Ketentuan </a>
                </span>
