        ...
        const htmlTemplate = ReactDOMServer.renderToStaticMarkup(
            ...
            >
                <span style={{ fontSize: '1.25rem', fontWeight: 600, display: 'block', marginBottom: '0.9rem' }}>
                    Pengajuan Pengembalian Pesanan { orderReturn.order_detail.number } Sedang Ditinjau
                </span>
                <span style={{ display: 'block', marginBottom: '0.9rem' }}>Hai {
                    orderReturn.order_detail.invoice_detail.customer_name
                },</span>
                <span style={{ display: 'block', marginBottom: '0.9rem' }}>
                    Tim kami saat ini sedang meninjau pengajuan pengembalian
                    <span style={{ fontWeight: 'bold' }}> {orderReturn.order_detail.product_detail.name} </span>
                    Anda dan akan menindaklanjutinya secepat mungkin. Cek <a href={orderReturn.order_detail.invoice_detail.address_detail.user_detail.company_detail.terms_and_condition_url} style={{ color: 'blue', cursor: 'pointer' }}> Syarat & Ketentuan </a>
                </span>
                ...
                <span style={{ display: 'block', marginBottom: '0.9rem' }}>
                    Kami akan memberitahukan mengenai status pengajuan pengembalian anda melalui email. Atau anda bisa memeriksa berkala melalui <a href={orderReturn.order_detail.invoice_detail.address_detail.user_detail.company_detail.return_url + "/" + orderReturn.id} style={{ color: 'blue', cursor: 'pointer' }}> Halaman Pengembalian </a>
                </span>
